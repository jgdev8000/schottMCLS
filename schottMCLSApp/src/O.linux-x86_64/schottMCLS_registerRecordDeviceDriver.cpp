...
/* Generated from ../O.Common/schottMCLS.dbd */
...
int schottMCLS_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/opt/iocs/schottMCLS";
...
/* schottMCLS_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"schottMCLS_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(schottMCLS_registerRecordDeviceDriver(*iocshPpdbbase));
}
